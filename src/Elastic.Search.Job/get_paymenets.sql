...
SELECT
	...
	CASE 
		...
		ELSE ''
	END Color,
	LTRIM(RTRIM(p.PHONE)) PhoneOne,
	LTRIM(RTRIM(p.PHONE2)) PhoneTwo,
...
LEFT JOIN PAYMENTRESULTCODES prc ON prc.CODE = p.RESULT_CODE AND prc.PAYMENT_TYPE = p.PAYMENT_TYPE
)
